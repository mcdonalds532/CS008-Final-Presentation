...
SlidingPuzzleApp::SlidingPuzzleApp() : Application(sf::VideoMode({321, 321}, 32), "Sliding Puzzle App", *this)
{
    n = model.getN();
    if(n == 3)
    {
        dimensions = 796.f;
        imagePath = "Applications/Sliding Puzzle/3x3_Puzzle.jpg";
    }
    else if(n == 4)
    {
        dimensions = 240.f;
        imagePath = "Applications/Sliding Puzzle/4x4_Puzzle.jpg";
    }
    else if(n == 5)
    {
        dimensions = 321.f;
        imagePath = "Applications/Sliding Puzzle/5x5_Puzzle.jpg";
    }
}
